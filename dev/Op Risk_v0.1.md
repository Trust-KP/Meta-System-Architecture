...
Operational resources are consumed through operational obligations.

Every operational activity consumes one or more operational resources. The quantity, duration and intensity of consumption depend upon the operational state of the insurance relationship rather than solely upon the insured risk.

Operational resource consumption therefore varies across contracts, counterparties and time.

## 5.1 Direct and Shared Consumption

Operational resource consumption may occur directly or indirectly.

Direct consumption occurs when operational resources are consumed solely in support of identifiable insurance contract groups.

Examples include:

* Individual underwriting activities
* Claims handling
* Policy issuance
* Loss adjusting
* Facultative placement

These resources can generally be attributed directly to the contracts that generated the operational obligation.

Shared consumption occurs where operational resources simultaneously support multiple insurance contracts or operational obligations.
...
These resources require systematic allocation because their consumption benefits multiple operational obligations simultaneously.

## 5.2 Consumption Intensity

Operational resource consumption is not constant.

Identical insurance contracts may require materially different operational effort depending upon their operational characteristics.

Consumption intensity is influenced by factors including:
...
Individual operational activities rarely consume a single operational resource.

Claims fulfilment, for example, simultaneously consumes:

* Interpretative resources through coverage assessment.
* Structural resources through claims systems and operational infrastructure.
* Regime resources through regulatory compliance and governance.
* Operational resources through claims handling and customer interaction.

Operational resource consumption therefore represents the combined utilisation of multiple resource classes in fulfilling a single operational obligation.

This multidimensional consumption forms the basis for the integrated measurement framework developed in the following chapter.

## 5.8 Towards Measurement

The preceding principles describe the dynamics of operational resource consumption independently of accounting treatment or organisational structure.

The remaining challenge is measurement.

Operational resources must ultimately be quantified, attributed and reported in a manner consistent with financial reporting requirements while preserving the underlying operational relationships identified in this framework.

The following chapter develops that measurement framework.
...
Operational resource consumption should be attributed according to the operational obligation that generated the need for that consumption.

Operational measurement therefore begins with the operational obligation rather than the organisational structure or accounting classification.

The framework proceeds through four stages.

#6.1 Measurement Hierarchy

Stage 1 – Identify the Operational Obligation

Determine why the operational activity exists.

Every operational activity supports one or more operational obligations:
...
The operational obligation identifies the operational purpose of the expenditure.

Stage 2 – Identify the Operational Driver

Determine the operational activity that generated the operational obligation.
...
Operational drivers explain why operational resources are consumed.

Stage 3 – Measure Operational Resource Consumption

Measure the operational resources consumed in fulfilling the operational obligation.

Operational activities consume one or more operational resource classes:
...
depending upon the operational activity.

Stage 4 – Attribute to Insurance Contract Groups

Operational resource consumption is attributed to the insurance contract groups that generated the underlying operational obligation.

Direct attribution is preferred whenever operational activities are contract-specific.

Shared operational resource consumption is attributed using systematic and rational allocation drivers consistent with IFRS 17.

The allocation driver should reflect the operational obligation generating the expenditure rather than organisational convenience.

## 6.2 Relationship with Existing Practice

Many insurers already perform operational attribution successfully where operational obligations are directly observable.
...
These activities are already recognised as directly attributable because the operational obligations generating them are immediately observable.

The framework therefore formalises rather than replaces these established practices.

## 6.3 The Attribution Gap

Operational attribution becomes progressively more difficult where operational activities simultaneously support multiple contracts.
...
These activities frequently appear as general administrative expenditure despite existing solely because insurance contracts create continuing operational obligations.

The principal contribution of the framework is therefore not acquisition or fulfilment attribution.

Those are already relatively mature.

Its contribution is extending the same operational measurement principle consistently to maintenance and governance activities.

## 6.4 Operational Support Layer

Some operational resources support the insurance portfolio collectively rather than individual insurance contracts.
...
These resources form the Operational Support Layer.

The Operational Support Layer preserves operational consistency while allowing shared operational resource consumption to be allocated systematically across insurance contract groups.

## 6.5 Progressive Implementation

The framework is intentionally designed for progressive implementation.

Phase 1 — Formalising Existing Practice

Phase 1 requires no new operational systems.
...
1. Classify each operational activity or operational risk according to its primary operational obligation.
2. Identify the operational driver generating that obligation.
3. Measure the associated operational resource consumption using existing operational expenditure.
4. Attribute operational resource consumption to insurance contract groups using existing systematic allocation drivers.
5. Operational expenditure that cannot reasonably be linked to insurance contract fulfilment remains within non-insurance operating expenditure.

Accordingly, Phase 1 formalises existing practice within a unified operational measurement framework rather than replacing current operational reporting.

Phase 2 — Operational Activity Measurement

Phase 2 progressively replaces proportional allocation with direct operational activity measurement.
...
* Renewal administration
* Policy servicing
* Computational utilisation
* Governance activities

Operational resource consumption becomes increasingly observable rather than inferred.

Phase 3 — Operational State Calibration

Phase 3 introduces operational state calibration.

Operational resource consumption becomes dependent upon both operational activity and operational state.

Operational adjustment factors may initially be deterministic before developing into stochastic state models as operational data maturity increases.

Throughout every implementation phase, the underlying measurement object remains operational resource consumption.

## 6.6 Relationship with IFRS 17

The framework complements the systematic and rational attribution principles required by IFRS 17.

Rather than beginning with accounting cost centres, the framework begins with operational obligations.

Operational expenditure is then attributed according to the operational resources consumed in fulfilling those obligations.

Directly attributable operational expenditure forms part of insurance service expenses.

Operational expenditure that cannot reasonably be linked to insurance contract fulfilment remains outside fulfilment cash flows and continues to be recognised as non-insurance operating expenditure.

The framework therefore provides a consistent operational interpretation of existing IFRS 17 attribution requirements without changing the underlying accounting principles.

## 6.7 Transition to Operational Risk

The framework developed to this point measures expected operational resource consumption.

Realised operational resource consumption will differ from expectation because operational relationships evolve, operational conditions change and operational activities vary through time.

The uncertainty surrounding realised operational resource consumption gives rise to operational risk.

Operational risk therefore represents uncertainty in the resources required to fulfil operational obligations rather than an independent operational phenomenon.

The following chapter derives operational risk measurement directly from the operational resource framework, establishing consistency between operational expense attribution and operational risk capital.
